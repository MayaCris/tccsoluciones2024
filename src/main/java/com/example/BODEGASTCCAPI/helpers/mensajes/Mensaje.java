...
public enum Mensaje {
    ...
    CAPACIDAD_VOLUMEN_OCUPADO("La capacidad de volumen ocupado no puede ser menor a 0"),
    CAPACIDAD_PESO_OCUPADO("La capacidad de peso ocupado no puede ser menor a 0"),
    ;
